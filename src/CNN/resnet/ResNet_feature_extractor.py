...
parser.add_argument('--input_dir', '-id', type=str, default=os.path.join('..', '..', '..', 'data', 'images', 'original', 'train2014'),
        help="Directory images are saved")
parser.add_argument('--output_dir', '-od', type=str, default=os.path.join('..', '..', '..', 'data', 'images', 'features', 'ResNet50', 'train2014'),
