...
training_dataset = DataLoader(train_data, img_feature_root=args.img_feature_root, img_feature_dim=args.img_feature_dim, preload_features=args.preload, img_root=args.img_root, dropout_ratio=args.dropout_ratio)

#model preparation
model = Image2CaptionDecoder(vocab_size=len(token2index), hidden_dim=args.hiden)
