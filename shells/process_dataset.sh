...
python src/DataPreparation/preprocess_captions.py --input_train data/captions/converted/formatted_json_train_en.pkl --exist_val --input_val data/captions/converted/formatted_json_val_en.pkl --output_dataset_path data/captions/processed/dataset_MSCOCO_en.pkl --output_dataset_bleu_path data/captions/bleu/dataset_MSCOCO_en_bleu.pkl --output_dict_path data/vocab_dict/dict_MSCOCO_en_train.pkl --lang en --off 5 --lower --period --ratio 0.5
...
python src/DataPreparation/preprocess_captions.py --input_train data/captions/converted/formatted_json_train_ch_mt.pkl --output_dataset_path data/captions/processed/dataset_MSCOCO_ch_mt.pkl --output_dataset_bleu_path data/captions/bleu/dataset_MSCOCO_ch_bleu.pkl --output_dict_path data/vocab_dict/dict_MSCOCO_ch_mt_train.pkl --lang ch --off 5 --lower --period --ratio 0.5
